    ...
    <header className="fixed top-0 w-full z-50 bg-slate-950/80 backdrop-blur-xl border-b border-white/5 flex justify-between items-center px-8 h-12 max-w-[1920px] mx-auto">
      <div className="flex items-center gap-12">
        ...
        <nav className="hidden md:flex gap-8">
          <a className="font-headline tracking-[-0.04em] uppercase text-xs font-bold text-indigo-400 border-b-2 border-indigo-500 pb-1" href="#classroom">Classroom</a>
          <a className="font-headline tracking-[-0.04em] uppercase text-xs font-bold text-slate-400 hover:text-slate-100 transition-colors" href="#curriculum">Curriculum</a>
          <a className="font-headline tracking-[-0.04em] uppercase text-xs font-bold text-slate-400 hover:text-slate-100 transition-colors" href="#students">Students</a>
          <a className="font-headline tracking-[-0.04em] uppercase text-xs font-bold text-slate-400 hover:text-slate-100 transition-colors" href="#resources">Resources</a>
        </nav>
      </div>
      <div className="flex items-center gap-6 z-50 relative">
        <div className="flex gap-4">
          <span className="material-symbols-outlined text-on-surface-variant hover:bg-white/5 p-2 rounded-lg cursor-pointer transition-all">notifications</span>
